<template>
  ...
  <h3 v-if="userObj.showGoal">{{ userObj.courseGoal }}</h3>
...
export default {
  setup() {
    /*
    // Separate refs
    // const courseGoal = 'To ace at my job';
    ...
    */
    ...
    Ref Object
    // const userObj = ref({
    //   courseGoal: 'To ace at my job',
    //   showGoal: true
    // });
    // const toggleGoal = () => {
    //   userObj.value.showGoal = !userObj.value.showGoal;
    // };
    // return {
    //   userObj: userObj,
    ...
    */
    ...
    const toggleGoal = () => {
      userObj.showGoal = !userObj.showGoal;
    };
    return {
      userObj: userObj,
      toggleGoal: toggleGoal
